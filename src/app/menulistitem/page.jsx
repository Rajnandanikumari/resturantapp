...
export default function Menulistitemss() {
    return (
        <>
            <Box sx={{ p: 3, maxWidth: 900, mx: 'auto', border: '1px solid black', height: 1400, marginTop: 7, marginBottom: 7, boxShadow: 12 }}>
                <Divider textAlign="center" sx={{}}>
                    <Typography component="span" variant="subtitle1" fontWeight="bold" sx={{ letterSpacing: 8, lineHeight: 'normal' }}>
                        YOUR RESTAURANT
                    </Typography>
                </Divider>
                <Box sx={{
                ...
                <Typography variant='h4' sx={{ mx: 4, marginLeft: "370px", marginTop: "-90px", fontStyle: "" }}>MENU</Typography>
                <Divider orientation="vertical" variant="middle" flexItem sx={{
                    height: "98px",
                    width: "120px",
                    borderRight: '1px solid',
            ...
            <Grid container size={{ md: 12, sm: 6 }}>
                <Grid sx={{ marginLeft: { xl: 101, md: 40 }, marginTop: -5, justifyContent: "center", marginBottom: 3 }}>
                    <Button component={Link} href="/menulistitem/orderbook" variant="contained" sx={{ width: 300, height: 40, backgroundColor: 'goldenrod', color: "white" }}>BOOK 🍽️ Meal</ Button >
                </Grid>
            </Grid >
